...
extension Router: URLRequestConvertible  {
    ...
    **/
    public var URLRequest: NSMutableURLRequest {
        ...
        let URLRequest = NSMutableURLRequest(URL: baseURL.appendingPathComponent(config.path)!)
...
extension Router {
    ...
    fileprivate var requestConfig: (path: String, params:[String: AnyObject]?, method: Alamofire.Method) {
        switch self {
